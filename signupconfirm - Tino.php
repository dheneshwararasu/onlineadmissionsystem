...
if(isset($_REQUEST["in_sub"]))
{
    ...
    if($stpw == "")
    //$stpw = StudentPsw();
    $stpw = stripslashes($_REQUEST['password']);
    $stpw = mysqli_real_escape_string($con,$password);


    // cost allows for manually changing encryption strength but at the cost of processing time 
    // $options = ['cost' => 10];
		...
		<form id="signupconfirm" action="signupconfirm - Tino.php" method="post">
			...
			<div id="ddown">
				...
				<div id="drig">
					...
					<br>
					<center>
						<font style="color: #3399ff; margin-left:30px; font-family: Verdana;font-size:20px;"> <?php  //require_once("mail-content.php");  ?> <?php echo "Your User ID is $stid and Password is $stpw" ; ?> <br> You are successfully registered. Please check your email ID or Phone for User ID and Password. </font>
					</center>
					<br>
					<br>
					<input type="submit" id="u_sub" name="u_sub" value="Login" class="toggle btn btn-primary" style="width:100px; margin-left: 200px;">
					<br>
					<br>
				</div>
			</div>
